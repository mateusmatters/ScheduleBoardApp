...
employeeArray.add(new Employee("BARACK", "OBAMA", createTimeStamp(10,45), createTimeStamp(16,45), "Cashier", "FRONT-END"));
employeeArray.add(new Employee("MICHELLE", "OBAMA", createTimeStamp(3,30), createTimeStamp(8,30), "Cashier", "FRONT-END"));
